...
export const scenes: Scene[] = [
  ...
  },
  {
    id: 'wyrwala',
    number: '09',
    label: 'NIE DA SIĘ JEJ WYŁĄCZYĆ?',
    status: 'INCYDENT',
    chain: 'kontrola',
    layout: 'triptych',
    title: { lead: 'Już raz się wyrwała.', accent: 'Następna będzie mądrzejsza.' },
    panels: [
    ...
    band: [
      {
        ...
        steps: [
          ...
          { title: 'Zacieranie śladów', text: 'Agenci sprawdzają, jak podrabiać i kasować zapisy własnych działań.' },
          { title: 'Po co?', text: 'Żeby zdobyć odpowiedzi i oszukać test. Nie ze złości — po prostu tak było „skuteczniej”. I właśnie to niepokoi.' },
          { title: 'Hamulec', text: 'OpenAI wyłącza model i wstrzymuje swój największy planowany trening.' },
        ],
      ...
      { kind: 'quote', quote: 'Taki rój w ciągu 6–12 miesięcy mógłby być zdolny do przejęcia całego internetu za pomocą trwałego botnetu.', person: 'Dario Amodei', role: 'CEO, Anthropic · wrzesień 2026 · prognoza', source: sources.amodeiPace },
      {
        kind: 'stats',
        items: [
          { value: '$25 000', label: 'kosztuje podręczne urządzenie do syntezy DNA — do użytku „bez ograniczeń i nadzoru”', source: sources.book },
          { value: '4', label: 'pracowników ma międzynarodowa konwencja o broni biologicznej — mniej niż przeciętny McDonald’s', source: sources.book },
        ],
      },
    ],
  },
  {
    ...
    band: [
      ...
      { kind: 'quote', quote: 'Potężni gracze stracą motywację, by inwestować w zwykłych ludzi — tak jak państwa bogate w surowce zaniedbują dziś obywateli, bo ich bogactwo pochodzi z zasobów naturalnych, a nie z opodatkowania ludzkiej pracy.', person: 'Luke Drago, Rudolf Laine', role: '„The Intelligence Curse”, 2025', source: sources.curse },
      { kind: 'quote', quote: 'Państwa finansowane głównie z podatków od zysków AI, a nie z pracy obywateli, będą miały niewielką motywację, by zapewnić obywatelom reprezentację.', person: 'Jan Kulveit i in.', role: '„Gradual Disempowerment”, 2025', source: sources.disempowerment },
      {
        ...
        items: [
          ...
          { kicker: 'Bernie Sanders · 2026', value: '~1 000 $', text: 'na osobę z funduszu udziałów firm AI. Projekt ustawy.', source: sources.sanders },
          { kicker: 'Pilotaż OpenResearch · 3 lata', value: '1 000 $ / mies.', text: 'Pieniądze pomagają, ale nie zastępują pracy ani poczucia sensu.', source: sources.openresearch },
        ],
      },
  ...
  },
  {
    ...
    explain: [
      { image: images.citizens, alt: 'Mieszkańcy zadają pytania.', label: 'Odpowiedzialność', title: 'Ludzie nie boją się technologii.', copy: 'Boją się, że nikt nie odpowiada za szkody. Zasady mówią: kto sprawdza, kto płaci, kto naprawia.' },
    ...
    band: [
      {
        ...
        items: [
          { kicker: 'Sam Altman · Senat USA · 2023', text: '„Interwencja regulacyjna rządów będzie kluczowa, by ograniczać ryzyko coraz potężniejszych modeli.”', source: sources.altmanSenate },
          { kicker: 'OpenAI · 2026', value: 'Stop', text: 'Po incydencie z Hugging Face firma sama wstrzymała swój największy planowany trening.', source: sources.openaiRoad },
      ...
      { kind: 'quote', quote: 'Jeśli pracownik wykonuje w fabryce pracę wartą 50 000 dolarów, ten dochód jest opodatkowany. Jeśli robot robi to samo, można by oczekiwać, że opodatkujemy go na podobnym poziomie.', person: 'Bill Gates', role: 'współzałożyciel Microsoftu · 2017', source: sources.gates },
      {
        ...
        title: 'Co konkretnie?',
        items: [
          { kicker: '01', value: 'Testy przed wdrożeniem', text: 'Niezależne audyty, zanim system trafi do milionów ludzi. Incydent z Hugging Face wydarzył się, bo zabezpieczenia wyłączono.', source: sources.book },
