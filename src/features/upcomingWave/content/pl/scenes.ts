...
export const scenes: Scene[] = [
    ...
    band: [
      ...
      },
      {
        ...
        items: [
          ...
          { value: '~9%', label: 'ludzi żyje dziś w skrajnej nędzy. Na początku XIX w. żyli w niej prawie wszyscy. Zmieniła to technologia (rozdz. 8)', source: sources.book },
        ],
      },
      {
        kind: 'evidence',
        ...
        items: [
          ...
          { kicker: 'Dario Amodei · Anthropic · 2024', value: '100 lat → 10', text: 'Postęp medycyny z 50–100 lat w ciągu 5–10 lat, dwa razy dłuższe życie w zdrowiu, miliardy ludzi wyciągnięte z biedy - tak wygląda jego wizja, jeśli z AI pójdzie dobrze.', source: { label: 'Machines of Loving Grace', url: 'https://darioamodei.com/essay/machines-of-loving-grace' } },
  ...
  },
  {
    ...
    upside: {
      ...
      text: 'Jeśli zyski trafią do wszystkich, szybsza praca może oznaczać krótszy tydzień i lepszą pracę - a nie tylko mniej etatów.',
      points: ['Czas i pieniądze na przekwalifikowanie, zanim praca zniknie', 'Wsparcie dochodu w czasie zmiany zawodu', 'Krótszy tydzień pracy zamiast zwolnień - pomysł, z którym wyszło samo OpenAI'],
      image: '/images/v2/upside-work-time-v2.jpg',
      alt: 'Słoneczna kuchnia po południu: mama z synem wyrabiają ciasto i się śmieją, w ogrodzie tata z babcią pielą warzywa, a w tle robot ładuje zmywarkę obok kosza z praniem.',
  ...
  },
  {
    ...
    panels: [
      ...
      { image: images.strain, label: 'Usługi się sypią', alt: 'Zatłoczona izba przyjęć w nocy; ludzie czekają na korytarzu, pielęgniarka biegnie.', focus: 'center 65%' },
    ],
    explain: [
    ...
    band: [
      ...
      { kind: 'quote', quote: 'A jak pan sprawi, żeby te roboty kupowały Fordy?', person: 'Walter Reuther', role: 'przywódca związku robotników motoryzacji, do przedstawiciela Forda - anegdota z lat 50.', source: sources.reuther },
      {
        ...
        items: [
          { kicker: 'Citrini Research · 2026 · scenariusz', value: 'Zero', text: 'Ile maszyny wydają na zakupy dla przyjemności? „Podpowiedź: zero.” Autorzy opisują pętlę „bez naturalnego hamulca”.', source: sources.citrini },
      ...
      },
      {
        ...
        caption: '8 na każde 10 pochodzi z tego, że ludzie zarabiają i wydają.',
  ...
  },
  {
    ...
    band: [
      ...
      { kind: 'quote', quote: 'Modele prawdopodobnie zbliżają się już do punktu, w którym - bez zabezpieczeń - mogłyby pomóc osobie z wykształceniem ścisłym, ale nie biologicznym, przejść cały proces wytworzenia broni biologicznej.', person: 'Dario Amodei', role: 'CEO, Anthropic · 2026', source: sources.amodei },
      {
        kind: 'stats',
        items: [
          { value: '25\u00a0000 $', label: 'kosztował biurkowy syntezator DNA - do użytku „bez ograniczeń i nadzoru” (stan na 2023 r.)', source: sources.book },
  ...
  },
  {
    ...
    explain: [
      ...
      { image: images.idle, alt: 'Bezczynni ludzie przed fabryką.', label: 'Kto decyduje', title: 'Bez tego decydują ci, którzy mają AI.', copy: 'Jeśli pieniądze zarabia AI, a nie ludzie - kto zdecyduje, ile dostaniemy? I czy w ogóle coś?' },
    ],
    band: [
      {
        kind: 'contrast',
  ...
  },
  {
    ...
    chain: 'rules',
    layout: 'triptych',
    title: { lead: 'Zasady, zanim szkody', accent: 'urosną.' },
    panels: [
    ...
    explain: [
      ...
      { image: images.noRules, alt: 'Gmach rządu i centra danych.', label: 'Czas', title: 'Zasady dają czas.', copy: 'Państwa, szkoły i ludzie potrzebują lat, żeby się dostosować. Hamulce pozwalają zyskać ten czas.' },
      { image: images.speed, alt: 'Szybkie wdrożenie AI.', label: 'Uczciwy podział', title: 'Nie zatrzymujmy - dzielmy uczciwie.', copy: 'Celem nie jest zatrzymanie postępu. Celem jest, żeby jego zyski i ryzyka rozkładały się sprawiedliwie.' },
    ],
    band: [
      {
        kind: 'evidence',
