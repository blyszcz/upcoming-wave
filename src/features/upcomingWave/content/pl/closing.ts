...
export const split = {
  ...
  left: {
    ...
    label: 'Państwo-zombie',
    text: 'Formalnie działa, w środku puste. Decydują ci, którzy mają AI.',
  ...
  right: {
    ...
    label: 'Lewiatan',
    text: 'Państwo ratuje się totalną kontrolą. Każdy krok pod okiem kamer.',
