  ...
  blocks: [
      { kind: 'quote', quote: 'Jeśli jej powstrzymanie okaże się niemożliwe, konsekwencje dla naszego gatunku będą dramatyczne, a nawet być może tragiczne. Zarazem jednak bez jej dobrodziejstw jesteśmy słabi i bezbronni.', person: 'Mustafa Suleyman', role: '„Nadchodząca fala”, rozdz. 1', source: sources.book },
      {
        ...
        items: [
          ...
          { kicker: 'Światowe Forum Ekonomiczne', value: '+170 / −92 mln', text: 'nowych i utraconych miejsc pracy do 2030 r. według ankiety wśród pracodawców (wszystkie trendy, nie tylko AI).', source: { label: 'WEF', url: 'https://reports.weforum.org/docs/WEF_Future_of_Jobs_Report_2025.pdf' } },
          { kicker: 'Dario Amodei · 2026', text: '„Jeśli zautomatyzujesz 90% pracy, wszyscy robią pozostałe 10%” - a z czasem te 10% staje się całą pracą.', source: { label: 'Fortune', url: 'https://fortune.com/2026/05/26/sam-altman-dario-amodei-walking-back-ai-jobs-apocalypse-prophecies-ipo/' } },
          { kicker: 'Mustafa Suleyman · rozdz. 12', text: '„Nie łudźmy się: zastój równa się katastrofie.” Pisze też, że „u podstaw technologii leży obietnica poprawy życia i korzyści daleko przewyższających koszty i wady”.', source: sources.book },
          { kicker: 'Sam Altman · 2026', text: '„Bardzo się cieszę, że się mylę” - zwolnień jest na razie mniej, niż sam przewidywał.', source: { label: 'Fortune', url: 'https://fortune.com/2026/05/26/sam-altman-dario-amodei-walking-back-ai-jobs-apocalypse-prophecies-ipo/' } },
        ],
      },
