export const hero = {
  ...
  subtitle: 'The people building it say it depends on the rules we set.',
  threatsLabel: 'They warn about',
  threats: ['Mass layoffs', 'Losing control of AI', 'Machines smarter than us', 'Bioweapons built with AI’s help'],
