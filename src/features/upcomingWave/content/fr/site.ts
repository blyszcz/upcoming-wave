export const site = {
  ...
  meta: {
    ...
    home: {
      title: 'L’IA pourrait être ce que nous avons créé de mieux - ou de pire',
      description: 'Un court guide visuel : ce que l’IA pourrait changer au travail, à l’argent et au pouvoir, ce qui pourrait bien tourner, et pourquoi ceux qui la construisent réclament des règles. Chaque fait est sourcé.',
    },
    sources: {
    ...
    ogAlt: 'L’IA pourrait être ce que nous avons créé de mieux - ou de pire. La même vague, deux avenirs : sombre au-dessus d’une ville, dorée au-dessus d’un parc.',
  },
  sourcesPage: {
  ...
  footer: {
    ...
    author: { label: 'Réalisé par', handle: '@blyzbyte', url: 'https://x.com/blyzbyte', with: '& l’IA' },
  },
};
